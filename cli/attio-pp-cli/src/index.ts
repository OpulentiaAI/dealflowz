...
// Required Northcliff structure (from attio-tracking.md)
const REQUIRED_OBJECTS = ["companies", "people", "deals"];
const REQUIRED_LISTS = ["Northcliff Deal Flow", "Broker Coverage"];
const REQUIRED_COMPANY_ATTRS = [
  "website", "revenue_estimate", "ebitda_estimate", "years_profitable", "geography",
  "source_type", "source_detail", "stage", "target_status", "nda_status", "cim_status",
  "financials_status", "model_status", "loi_status", "last_touch", "next_touch",
  "reactivation_date", "not_target_reason", "evidence_summary",
];
const REQUIRED_PEOPLE_ATTRS = ["email_addresses", "job_title", "phone", "broker_firm", "role_type"];
...
// Compound: verify workspace has required Northcliff objects, lists, and attributes.
